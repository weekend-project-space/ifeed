<template>
  <div class="space-y-6">
    <section class="rounded-2xl border border-outline/30 bg-surface-container">
      ...
      <div v-if="historyStore.loading" class="py-12 text-center text-text-muted">加载中...</div>
      ...
      <ul v-else class="divide-y divide-outline/20">
        ...
        <li v-if="!items.length" class="px-6 py-10 text-center text-text-muted">还没有阅读记录。</li>
      </ul>
