<template>
  <div>
    ...
    <div v-else-if="!mixFeedsStore.myMixFeeds.length" class="text-center py-16">
      ...
      <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">没有混合订阅</h2>
      <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">创建混合订阅以聚合多个来源的内容</p>
      <button
          @click="openCreateModal"
    ...
    >
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-sm w-full p-5">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-5">
          确定要删除混合订阅 <strong>{{ feedToDelete.name }}</strong> 吗? 此操作无法撤销。
        </p>
