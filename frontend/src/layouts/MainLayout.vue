<template>
  ...
  >
      ...
      >
        <div class="flex h-full flex-col overflow-hidden">
          <div class="flex items-center justify-between px-4 pb-4">
            <RouterLink :to="{ name: 'home' }" class="flex items-center gap-2 text-base font-semibold text-text" @click="mobileNavOpen = false">
              <span class="inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-primary text-primary-foreground">i</span>
              <span class="leading-none">iFeed</span>
            </RouterLink>
            <button
              type="button"
          ...
          <nav class="flex-1 space-y-5 overflow-y-auto px-2">
            ...
            >
              ...
              <div
                v-if="index < navSections.length - 1"
                class="px-3 pt-2"
              >
    ...
    <div class="flex flex-1 overflow-hidden">
      <aside class="hidden w-64 shrink-0 flex-col border-r border-outline/30 bg-surface py-6 lg:flex">
        <div class="flex h-full flex-col overflow-hidden">
          <div class="px-5 pb-3">
            <p class="text-[11px] font-semibold text-text-muted/80">导航</p>
          </div>
